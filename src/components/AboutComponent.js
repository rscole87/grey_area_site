        ...
        <Container>
          <Row>
            ...
            <Col id="about-form-div" className="ps-sm-5" sm="4">
              <p className="pull-quote text-center">The truth is what you're seeking, and it's our mission to get you there.</p>

              <div className="text-center">
                <button className="input-bttn" onClick={props.toggleModal}>
                  Get Started
                </button>
              </div>
